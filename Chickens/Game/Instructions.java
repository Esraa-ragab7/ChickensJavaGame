...
public class Instructions implements GLEventListener, KeyListener {
    ...
    String textureNames[] = {"iages\\instructions3.png"};
    ...
    public void handleKeyPress() {
        if (isKeyPressed(KeyEvent.VK_BACK_SPACE)) {
           ...
           // eventListener1.goto1=0;
            ...
            glcanvas.removeGLEventListener((Instructions) lst.get(5));
            glcanvas.removeKeyListener((Instructions) lst.get(5));

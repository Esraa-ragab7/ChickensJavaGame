...
public class Medal implements GLEventListener, KeyListener {
    ...
    String textureNames[] = {"iages\\medal.png","iages\\win_1.png"};
...
//try to recall with index 5 and x,y random
    ...
    public void handleKeyPress() {
        if (isKeyPressed(KeyEvent.VK_ENTER)) {
            ...
            //eventListener.leel=2*listener.go-2;
            eventListener1.display(glcanvas);
            glcanvas.removeGLEventListener((Medal) lst.get(7));
            glcanvas.removeKeyListener((Medal) lst.get(7));
